...
import br.com.cde.tableModel.TabelaModeloTamanho;
...
public class TelaCadastroTamanho extends javax.swing.JFrame {
    ...
    public TelaCadastroTamanho() {
        ...
        tabelaTamanho.setModel(new TabelaModeloTamanho(new TamanhoDAO().listarTamanho()));
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro Tamano de Peças");

        jPanel1.setBackground(new java.awt.Color(0, 204, 204));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(102, 102, 102));
        jLabel1.setText("Tamanho de Peças");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtCodigo, javax.swing.GroupLayout.DEFAULT_SIZE, 66, Short.MAX_VALUE)
        ...
        painelTamanho.addTab("Cadastrar Tamanho", jPanel2);
        ...
        painelTamanho.addTab("Consultar Tamanhos", jPanel3);
    ...
    private void btCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCadastrarActionPerformed
        ...
        if (txtTamanho.getText().isEmpty() || txtDescricao.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Existem campos em branco!");
        } else {

            tamanho.setTamanho(txtTamanho.getText());
            tamanho.setDescricao(txtDescricao.getText());

            dao.cadastrarTamanho(tamanho);
    ...
    private void tabelaTamanhoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaTamanhoMouseClicked
        ...
        txtCodigo.setText(tabelaTamanho.getValueAt(tabelaTamanho.getSelectedRow(), TabelaModeloTamanho.COLUNA_CODIGO).toString());
        txtTamanho.setText(tabelaTamanho.getValueAt(tabelaTamanho.getSelectedRow(), TabelaModeloTamanho.COLUNA_TAMANHO).toString());
        txtDescricao.setText(tabelaTamanho.getValueAt(tabelaTamanho.getSelectedRow(), TabelaModeloTamanho.COLUNA_DESCRICAO).toString());
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        // TODO add your handling code here:
        tamanho.setCódigoTamanho(Integer.parseInt(txtCodigo.getText()));
        dao.excluirTamanho(tamanho);

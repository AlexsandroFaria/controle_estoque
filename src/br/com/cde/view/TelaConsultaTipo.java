 ...
 * @author alafaria
 */
public class TelaConsultaTipo extends javax.swing.JFrame {
    ...
    public TelaConsultaTipo() {
     ...
     public String calcularValor() {
        ...
        for (int i = 0; i <= tabelaTipo.getRowCount() - 1; i++) {
            soma += Double.parseDouble(tabelaTipo.getValueAt(i, 4).toString());
        }
    ...
    private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
        ...
        tabelaTipo.setModel(new TabelaModeloProduto(new ProdutoDAO().listarProdutosPorTipo(pesquisar)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaTipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaConsultaTipo().setVisible(true);
            }
        });
    }

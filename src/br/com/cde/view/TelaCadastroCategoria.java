...
import br.com.cde.tableModel.TabelaModeloCategoria;
...
public class TelaCadastroCategoria extends javax.swing.JFrame {
    ...
    public TelaCadastroCategoria() {
        ...
        tabelaCategoria.setModel(new TabelaModeloCategoria(new CategoriaDAO().listarCategoria()));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Categoria de Roupas");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, 312, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        painelTamanho.addTab("Cadastrar Categoria", jPanel2);
        ...
        painelTamanho.addTab("Consultar Categoria", jPanel3);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(painelTamanho, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
                .addGap(25, 25, 25)
                .addComponent(btNovo)
    ...
    private void tabelaCategoriaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaCategoriaMouseClicked
        ...
        txtCodigo.setText(tabelaCategoria.getValueAt(tabelaCategoria.getSelectedRow(), TabelaModeloCategoria.COLUNA_CODIGO_CATEGORIA).toString());
        txtCategoria.setText(tabelaCategoria.getValueAt(tabelaCategoria.getSelectedRow(), TabelaModeloCategoria.COLUNA_TAMANHO_CATEGORIA).toString());
        txtDescricao.setText(tabelaCategoria.getValueAt(tabelaCategoria.getSelectedRow(), TabelaModeloCategoria.COLUNA_DESCRICAO_CATEGORIA).toString());
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        // TODO add your handling code here:
        categoria.setCodigoCategoria(Integer.parseInt(txtCodigo.getText()));
